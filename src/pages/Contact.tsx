...
import { Mail, MapPin, Phone, Send, Github, Linkedin, CheckCircle, Facebook } from "lucide-react";
import { z } from "zod";
...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "sereysunteang@gmail.com",
      href: "mailto:sereysunteang@gmail.com",
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+855 (0) 98 255 128",
      href: "tel:+85598255128",
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  // Social links
  const socialLinks = [
    { icon: Github, label: "GitHub", href: "https://github.com/Sunteang" },
    { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/sunteangserey/" },
    { icon: Facebook, label: "Facebook", href: "https://www.facebook.com/sunt.teang" },
  ];
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-body font-medium text-sm">Hello, </span>
                </div>
                <p className="font-body text-sm text-muted-foreground">
                  I'm happy to connect! just want to say hi, feel free to reach out.
                </p>
              </CardContent>
            </Card>
          </motion.div>
