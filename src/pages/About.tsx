...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Passionate",
      description:
        "I love what I do and it shows in every project I undertake.",
    },
    {
      icon: Lightbulb,
      title: "Creative",
                ...
                <CardContent className="pt-6 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-heading font-medium">Serey Sunteang</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-heading font-medium">Web Developer</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          >
            ...
            <div>
              ...
              <div className="font-body text-muted-foreground space-y-4 leading-relaxed">
                <p>
                  I'm Sunteang SEREY as a passionate web developer with over 1
                  year of experience, I specialize in creating stunning,
                  user-friendly websites. My journey in tech started with a love
                  for problem-solving and design, which led me to master modern
                  web technologies.
                </p>
                <p>
                  With a background in Computer Science and several years of
                  hands-on experience, I've developed a keen eye for design and
                  a solid foundation in both frontend and backend technologies.
                  I believe that great software is not just about code—it's
            ...
            <div>
              ...
              <div className="font-body text-muted-foreground space-y-4 leading-relaxed">
                <p>
                  My goal is to continue growing as a developer while making
                  meaningful contributions to innovative projects. I'm
                  particularly interested in:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Building scalable, user-centric applications</li>
                  <li>Exploring emerging technologies like AI</li>
